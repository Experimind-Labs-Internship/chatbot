...
export default function Abayas() {
  ...
  async function loadProducts() {
    try {
      ...
      const abayas = data.filter(
        (product) =>
          product.category?.toLowerCase() === "abayas"
      );
    ...
    <main className="bg-[#FAF8F5] pt-32 pb-24">
      ...
      <section className="max-w-7xl mx-auto px-6 text-center">
        ...
        <p className="mt-6 text-[#6A625B] max-w-2xl mx-auto">
          Discover elegant abayas crafted with timeless style,
          premium fabrics, and effortless sophistication.
        </p>
