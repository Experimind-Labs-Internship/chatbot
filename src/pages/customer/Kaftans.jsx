...
export default function Kaftans() {
  ...
  async function loadProducts() {
    try {
      ...
      const kaftans = data.filter(
        (product) =>
          product.category?.toLowerCase() === "kaftans"
      );
    ...
    <main className="bg-[#FAF8F5] pt-32 pb-24">
      ...
      <section className="max-w-7xl mx-auto px-6 text-center">
        ...
        <p className="mt-6 text-[#6A625B] max-w-2xl mx-auto">
          Discover elegant kaftans designed with premium fabrics,
          effortless comfort, and timeless sophistication.
        </p>
